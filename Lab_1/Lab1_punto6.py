...
# Title: Lab1_punto6_Filter
# Author: Josman_Rico_Julian_Romero_B1C_G5
...
class Lab1_punto6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab1_punto6_Filter", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_punto6_Filter")
        ...
        self.high_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.high_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source("C:\\Users\\julia\\OneDrive\\Documentos\\UIS\\Documentos Semestre 7\\Comunicaciones 1\\Laboratorio\\Lab_1\\TheBeatles _Don'tLetMeDown.wav", True)
